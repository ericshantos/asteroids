...
class HUDRenderer:
    ...
    def render(self, fps: int, showing_FPS: bool, state: str, score: int):
    ...
    def display_text(self, text: str, x: Optional[int] = None, y: Optional[int] = None, font: Font = Font.F30, color: Tuple[int, int, int] = (200,200,200)):
    ...
    def display_attract_mode(self) -> None:
    ...
    def display_fps(self, fps: int) -> None:
